...
class TestPaymentStatusUseCases:
    ...
    def payment_status(self):
        return PaymentStatus(name='pending', description='Payment pending', id=1)
    ...
    def test_update_payment_status_usecase(self, payment_status_gateway, payment_status):
        ...
        dto = UpdatePaymentStatusDTO(id=1, name='completed', description='Payment completed')
        result = self.update_payment_status_usecase.execute(1, dto)
    ...
    def test_update_payment_status_usecase_not_found(self, payment_status_gateway):
        ...
        dto = UpdatePaymentStatusDTO(id=1, name='completed', description='Payment completed')
        with pytest.raises(EntityNotFoundException):
            self.update_payment_status_usecase.execute(1, dto)