...
class TestOrderStatusRepository:
    ...
    def test_create_order_status_success(self):
        order_status = OrderStatus(status="PENDING", status_description="Order is pending")
        ...
        assert created_order_status.status_description == "Order is pending"
        ...
        assert db_order_status.status_description == "Order is pending"

    def test_exists_by_status_success(self):
        OrderStatusFactory(status="PENDING", status_description="Order is pending")
    ...
    def test_get_by_status_success(self):
        ...
        assert order_status_from_db.status_description == "Order is pending"

    def test_get_by_id_success(self):
        order_status = OrderStatusFactory(status="PENDING", status_description="Order is pending")
    ...
    def test_get_all_success(self):
        OrderStatusFactory(status="PENDING", status_description="Order is pending")
        OrderStatusFactory(status="CONFIRMED", status_description="Order is confirmed")
        ...
        assert order_statuses_from_db[0].status_description == "Order is pending"
        assert order_statuses_from_db[1].status == "CONFIRMED"
        assert order_statuses_from_db[1].status_description == "Order is confirmed"
    
    def test_update_order_status_success(self):
        order_status: OrderStatus = OrderStatusFactory(status="PENDING", status_description="Order is pending")

        order_status.status = "CONFIRMED"
        order_status.status_description = "Order is confirmed"
        ...
        assert updated_order_status.status_description == "Order is confirmed"
        ...
        assert db_order_status.status_description == "Order is confirmed"
