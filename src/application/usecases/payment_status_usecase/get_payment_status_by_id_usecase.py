...
class GetPaymentStatusByIdUseCase:
    
    def __init__(self, payment_status_gateway: IPaymentStatusRepository):
        self.payment_status_gateway = payment_status_gateway
    
    @classmethod
    def build(cls, payment_status_gateway: IPaymentStatusRepository) -> 'GetPaymentStatusByIdUseCase':
        return cls(payment_status_gateway)
    
    def execute(self, payment_status_id: int) -> PaymentStatus:
